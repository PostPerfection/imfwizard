//! ProRes detection and IMF packaging support.
...
/// Options for creating a ProRes-based IMP.
#[derive(Debug, Clone)]
pub struct ProResImpOptions {
...
impl Default for ProResImpOptions {
    fn default() -> Self {
        Self {
...
mod tests {
    ...
    fn test_parse_profile() {
        ...
        assert_eq!(parse_profile("unknown"), ProResProfile::Hq); // default
    }

    #[test]
    fn test_default_options() {
        let opts = ProResImpOptions::default();
        ...
        assert_eq!(opts.issuer, "IMF Wizard");
    }
